...
<template>
    ...
    <div class="bg-red-600 text-white text-center px-4 py-3 text-sm font-bold">
        ?? IMPORTANT: Do Not Close This Page � This Offer Is Only Available Right Now
    </div>
    ...
    <section class="bg-white px-4 py-14 md:px-8">
        <div class="mx-auto max-w-4xl text-center">
            <p class="text-xs font-semibold uppercase tracking-widest text-yellow-600">The Reality Right Now</p>
            <h2 class="mt-3 text-3xl font-extrabold text-slate-900 md:text-4xl">Video Is Where Attention Lives</h2>
            ...
            <div class="mt-8 grid gap-4 md:grid-cols-3 text-left">
                ...
                <div class="rounded-2xl border border-slate-200 bg-slate-50 p-5 text-center">
                    ...
                    <p class="text-sm font-semibold text-slate-800">Extra tools needed</p>
                    <p class="mt-1 text-xs text-slate-500">With this upgrade, your storybook becomes a video. No editing software. No camera. No skills needed.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- WHAT YOU UNLOCK -->
    <section class="bg-yellow-50 px-4 py-16 md:px-8">
        <div class="mx-auto max-w-5xl">
            <div class="text-center mb-10">
                <p class="text-xs font-semibold uppercase tracking-widest text-yellow-700">PRO Video Upgrade</p>
                <h2 class="mt-2 text-3xl font-extrabold text-slate-900 md:text-4xl">Unlock The Most Valuable Feature In The Entire Funnel</h2>
            </div>
    ...
    <section class="bg-white px-4 py-14 md:px-8">
        <div class="mx-auto max-w-3xl text-center">
            <h2 class="text-2xl font-extrabold text-slate-900 md:text-3xl">Compare What You'd Normally Pay</h2>
            <div class="mt-8 grid gap-3 md:grid-cols-3 text-sm">
                ...
                <div class="rounded-2xl border-2 border-yellow-400 bg-yellow-50 p-5">
                    <p class="font-bold text-slate-900">PRO Video Upgrade</p>
                    <p class="mt-2 text-2xl font-extrabold text-yellow-600">One Time</p>
                    <p class="mt-1 text-slate-600 text-xs font-semibold">Right here. Right now.</p>
                </div>
            </div>
        </div>
    </section>
